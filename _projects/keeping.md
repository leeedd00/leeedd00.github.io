...
| 시기 | 단계 | 팀 | 내용 |
|------|------|-----|------|
| 2025.09 – 2025.12 | 1차 · 웹 버전 | 3인 | 웹 플랫폼과 수요예측 파이프라인 → [1차 프로젝트 보기](/projects/keeping-web/) |
| 2025.11 – 2025.12 | 린스타트업 스쿨 MVP | 팀 Autoful | 모바일 MVP 앱 외주 발주 · 검수 → [프로젝트 보기](/projects/lean-startup-mvp/) |
